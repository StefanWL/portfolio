...
class PageEdit extends Component {
    ...
    constructor (props) {
        super(props);
        this.state = {
            file: 'data:image/jpeg;base64,' + this.props.page.image
        }
    }
            ...
            <div className="banner row justify-content-center">
                <div className="col-10 col-md-6">
                    <form encType="multipart/form-data" onSubmit={e => this.handleSubmit(e)}>
                        ...
                        <input id="title" name="title" className="text-input w-100 mb-3" type="text" defaultValue={page?.title}/>
                        <label htmlFor="content">Content</label>
                        <textarea id="content" name="content" rows="6" className="w-100 mb-3" defaultValue={page?.content}></textarea>
