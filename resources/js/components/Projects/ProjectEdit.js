...
class ProjectEdit extends Component {
    static displayName = ProjectEdit.name;
    constructor (props) {
        super(props);
        this.state = {
            file: 'data:image/jpeg;base64,' + this.props.project.image
        }
    }
            ...
            <div className="banner row justify-content-center">
                <div className="col-10 col-md-6">
                    <form encType="multipart/form-data" onSubmit={e => this.handleSubmit(e)}>
                        ...
                        <input id="title" name="title" className="text-input w-100 mb-3" type="text" defaultValue={project?.title}/>
                        <label htmlFor="url">Site URL</label>
                        <input id="url" name="url" className="text-input w-100 mb-3" type="text" defaultValue={project?.url}/>
                        <label htmlFor="repository">Repository</label>
                        <input id="repository" name="repository" className="text-input w-100 mb-3" type="text" defaultValue={project?.repository}/>
                        <label htmlFor="content">Content</label>
                        <textarea id="content" name="content" rows="6" className="w-100 mb-3" defaultValue={project?.content}></textarea>
